      ...
      children: [
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Row(children: [
                  ...
                  TextButton(onPressed: () => context.push(Routes.tutor), child: const Text('TUTOR')),
                ]),
              ),
            ),
        ],
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Row(children: [
                  ...
                  OutlinedButton(onPressed: () => context.push(Routes.tutor), child: const Text('REVISE')),
                ]),
              ),
            ),
        ],
        ...
        GameCard(
          child: Row(children: [
            ...
            const SizedBox(width: 10),
            FilledButton(onPressed: () => context.push(Routes.tutor), style: FilledButton.styleFrom(backgroundColor: AppColors.secondary), child: const Text('OPEN')),
          ]),
        ),
      ],
    );
