          ...
          ListView(
            ...
            children: [
              ...
              Center(
                child: Semantics(
                  label:
                      'Accuracy ${r.accuracy.round()} percent, ${r.performanceLabel}',
                  child: Stack(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Icon(
                            _statusIcon(r.performanceLabel),
                            size: 18,
                            color: _scoreColor(r.accuracy),
                          ),
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: _StatCard(
                      label: 'TIME',
                      value: _fmt(r.timeElapsedSeconds),
                          ...
                          if (d != null && d.xpGained > 0)
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                if (r.config.type != GameType.quizBattle &&
                                    r.config.type != GameType.speedRun)
                                  const Text(
                                    'Local preview • Quiz games award real XP',
                                    style: TextStyle(
                                      fontSize: 11,
